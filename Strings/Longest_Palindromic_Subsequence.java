...
public class Longest_Palindromic_Subsequence {
    public static void main(String[] args) {
        String text1 = "abcde";
        //reversing because palindrom are same when reversed soo apply same
        String revtext1 = "edcba";
        
        int n = text1.length();
        int m = revtext1.length();
        int[][] dp = new int[n][m];
        for(int[] i: dp){
            Arrays.fill(i,-1);
        } 
        System.out.print(check(n-1, m-1, text1, revtext1, dp));
    }
